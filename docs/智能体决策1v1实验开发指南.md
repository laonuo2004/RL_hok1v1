...
| lineups.blue_camp/lineups.red_camp | hero_id | 英雄ID,当前版本仅支持111 鲁班七号. |
...
for episode in range(EPISODES):
    ...
    usr_conf = {
        "diy":{
            ...
            "lineups": [[{'hero_id': 111}], [{'hero_id': 111}]],
        }
    }
...
- 鲁班七号英雄私有的状态和行为（如连招之类的复杂行为）还没有进行相关建模，用户可以通过针对性优化提高上限
